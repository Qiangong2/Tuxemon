...
sys.argv = [sys.argv[0]]
RAPT_ARCHIVE = "renpy-7.3.5-rapt.zip"
RAPT_LINK = "https://www.renpy.org/dl/7.3.5/" + RAPT_ARCHIVE
SIX_ARCHIVE = "six-1.14.0.tar.gz"
SIX_LINK = "https://files.pythonhosted.org/packages/21/9f/b251f7f8a76dec1d6651be194dfba8fb8d7781d10ab3987190de8391d08e/" % SIX_ARCHIVE
...
def install_dependencies():
    ...
    if not os.path.exists("tuxemon/six.py"):
        ...
        os.rename("six-1.14.0/six.py", "tuxemon/six.py")
...
if __name__ == "__main__":
    ...
    if not os.path.exists("build/rapt/tuxemon"):
        ...
        os.symlink("../../mods/tuxemon", "build/rapt/tuxemon")

    # Check md5 hash instead of copying every time.
    print "Copying icon and splash images..."
    shutil.copyfile("mods/tuxemon/resources/gfx/icon.png", "build/rapt/templates/pygame-icon.png")
